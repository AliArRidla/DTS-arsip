                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <div class="form-group ">
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                <label class="control-label" for="kategori_id">Kategori <span class="text-danger">*</span></label>
                                                </div>
                                                <div id="ctrl-kategori_id-holder" class="col-sm-8"> 
                                                    <select required=""  id="ctrl-kategori_id" name="type_kategori_id"  placeholder="Select a value ..."    class="custom-select" >
                                                        <option value="">Select a value ...</option>
                                                        <?php 
                                                        $surat_id_kategoris = $comp_model -> pilih_surat_kategori_id_option_list();
                                                        if(!empty($surat_id_kategoris)){
                                                        foreach($surat_id_kategoris as $option){
                                                        $value = (!empty($option['value']) ? $option['value'] : null);
                                                        $label = (!empty($option['label']) ? $option['label'] : $value);
                                                        $selected = $this->set_field_selected('type_kategori_id',$value, "");
                                                        ?>
