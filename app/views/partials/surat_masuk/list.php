                                    ...
                                    <table class="table  table-striped table-sm text-left">
                                        <thead class="table-header bg-light">
                                            <tr>
                                                ...
                                                <th  class="td-Kategori_surat"> Kategori Surat</th>
                                        ...
                                        if(!empty($records)){
                                        ?>
                                        <tbody class="page-data" id="page-data-<?php echo $page_element_id; ?>" style="color: white;">
                                            <!--record-->
                                            <?php
                                            $counter = 0;
                                            ...
                                            <tr style="font-color">
                                                <th class=" td-checkbox">
                                                    ...
                                                    <td class="td-Kategori_surat">
                                                    <?
                                                        $kategoriku = $surat_id_kategoris = $comp_model -> pilih_nama_kategori_id_option_list($data['type_kategori_id']);
                                                            if(!empty($surat_id_kategoris)){
                                                            foreach($surat_id_kategoris as $option){
                                                            $valueku = (!empty($option['value']) ? $option['value'] : null);
                                                            $labelku = (!empty($option['label']) ? $option['label'] : $valueku);
                                                            $selected = $this->set_field_selected('type_kategori_id',$valueku, "");       
                                                            }                                                     
                                                        }
                                                    ?>

                                                        <span  data-value="<?php echo $kategori ?>" 
                                                            data-pk="<?php echo $data['No_Agenda'] ?>" 
                                                            data-url="<?php print_link("surat_masuk/editfield/" . urlencode($data['No_Agenda'])); ?>" 
                                                            data-name="type_kategori_id" 
                                                            data-title="Enter Asal Surat" 
                                                            data-placement="left" 
                                                            data-toggle="click" 
                                                            data-type="text" 
