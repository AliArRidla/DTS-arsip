<div id="topbar" class="navbar navbar-expand-md fixed-top navbar-dark" style="background-color: rgba(45, 73, 93, 1);border:0px">
    <div class="container-fluid">
        ...
        if(user_login_status() == true ){ 
        ?>
        <nav id="sidebar" class="navbar-dark " style="background-color: rgba(45, 73, 93, 1);">
