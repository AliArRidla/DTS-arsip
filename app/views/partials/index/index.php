            ...
            <div class="container">
                <div class="row ">                   
                    <div class="col-md-4 comp-grid" >
                        ...
                        <div  class="bg-light p-3 animated fadeIn page-content" style="margin-top:40%" >
                            <div>
                          ...
                          <div class="fadeIn animated mb-4 ">
                                <div class="text-capitalize">
                                  <!-- <h2 align="center" class="text-capitalize">Aplikasi Arsip <br>Surat Berbasis WEB </h2> -->
                                    ...
                                    <div class="" align="center"><div><img src="assets/images/landing.png" width="70%" /></div>
                                    <div align ="center" style="color:rgba(255,255,255,1)"><br>
                                    Selamat datang di Sistem Arsip Surat Berbasis Web. 
                                    Sistem ini merupakan sistem yang digunakan untuk mencatat surat 
                                    masuk dan surat keluar dan disertai dengan bukti upload berkas</div>
                                    </div>
                              </div>
                            </div>
                        </div>
