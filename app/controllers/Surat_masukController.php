...
class Surat_masukController extends SecureController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		if(!empty($request->search)){
			...
			$search_condition = "(
				...
				surat_masuk.type_kategori_id LIKE ? OR 
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("Nomor_Surat","Tanggal_surat","tanggal_terima","Asal_surat","perihal","file_surat","penerima","type_kategori_id");
			...
			$this->sanitize_array = array(
				...
				'type_kategori_id' => 'sanitize_string',
			);
	...
	function editfield($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		//editable fields
		$fields = $this->fields = array("No_Agenda","Nomor_Surat","Tanggal_surat","tanggal_terima","Asal_surat","perihal","file_surat","penerima","type_kategori_id");
		$page_error = null;
		if($formdata){
			$postdata = array();
	...
	function delete($rec_id = null){
		...
		if($bool){
			$this->set_flash_msg("Data berhasil di delete", "success");
		}
